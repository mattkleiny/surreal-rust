...
impl<T> AddAssign for Vector2<T> where T: Numeric {
...
impl<T> SubAssign for Vector2<T> where T: Numeric {
...
impl<T> MulAssign for Vector2<T> where T: Numeric {
...
impl<T> DivAssign for Vector2<T> where T: Numeric {
...
impl<T> MulAssign<T> for Vector2<T> where T: Numeric {
...
impl<T> DivAssign<T> for Vector2<T> where T: Numeric {
